...
if not Viks.loot.lootframe == true then return end
...
local createSlot = function(id)
	...
	count:SetFont(Viks.media.font, 10, "OUTLINE")
	count:SetText(1)
	frame.count = count
...
title:SetFont(Viks.media.font, 10, "OUTLINE")
...
addon:SetWidth(256)
addon:SetHeight(60)
addon:SetBackdropColor(unpack(Viks.media.backdropcolor))
