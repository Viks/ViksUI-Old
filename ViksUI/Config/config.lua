...
----------------------------------------------------------------------------------------
--	Action Bars // Removed from addon pack. Need cleanup!
----------------------------------------------------------------------------------------
Viks["actionbar"] = {		
...
Viks["automation"] = {
	...
	["AutoGreed"] = false,						-- automaticly greed green items?
	["AutoDisenchant"] = false,					-- automaticly dis green items?
}
...
Viks["media"] = {
	...
	["whisp_sound"] = [[Interface\AddOns\ViksUI\Media\sounds\whisper.mp3]],				-- Sound for wispers
	["warning_sound"] = [[Interface\AddOns\ViksUI\Media\sounds\warning.mp3]],			-- Sound for warning
	["proc_sound"] = [[Interface\AddOns\ViksUI\Media\sounds\proc.mp3]],					-- Sound for procs
}
...
Viks["unitframes"] = {
	...
	["RaidShowSolo"] = true,															-- show raid frames even when solo
	...
	["showHarmony"] = true, 															-- show Monk Harmony bar
	["showShadowOrbsBar"] = true, 														-- show Shadow Priest Shadow Orbs bar
