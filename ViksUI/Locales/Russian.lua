...
L_MISC_UI_OUTDATED = "Ваша версия ViksUI устарела. Вы можете скачать последнюю версию с www.shestak.org"
...
L_STATS_CHANGE_SORTING = "[Гильдия] ПКМ приглашения и шепот, СКМ изменяет сортировку, Шифт+СКМ изменяет порядок сортировки."
...
L_STATS_XP_RATE = "Оценка XP на уровне"
...
L_STATS_SESSION_XP = "Оценка XP за сеанс"
