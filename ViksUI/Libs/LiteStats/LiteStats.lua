...
if bags.enabled then
	Inject("Bags", {
		...
		OnEvent = function(self)
			...
			--self.text:SetTextColor(unpack(Viks.media.pxcolor1))
			--self.text:SetFont(Viks.media.pxfont, Viks.media.pxfontsize, Viks.media.pxfontFlag)
			--self.text:SetText(format("bags :"..qColor..free.."/"..total))
