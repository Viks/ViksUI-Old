...
frame:SetScript("OnEvent", function(self, event)
	...
	barmod.ApplySettings = function(self, win)
		...
		titlefont:SetFont(Viks.font.stylization_font, Viks.font.stylization_font_size, Viks.font.stylization_font_style)
		titlefont:SetShadowColor(0, 0, 0, Viks.font.stylization_font_shadow and 1 or 0)
		...
		if win.db.enabletitle then
			...
			skada.button.bg:SetTexture(Viks.media.texture)
			skada.button.bg:SetVertexColor(unpack(Viks.media.bordercolor))
		...
		skada:SetTexture(Viks.media.texture)
		skada:SetSpacing(7)
		...
		for _, win in ipairs(self:GetWindows()) do
			for i, v in pairs(win.bargroup:GetBars()) do
				if not v.BarStyled then
					...
					v.label:SetFont(Viks.font.stylization_font, Viks.font.stylization_font_size, Viks.font.stylization_font_style)
					...
					v.timerLabel:SetFont(Viks.font.stylization_font, Viks.font.stylization_font_size, Viks.font.stylization_font_style)
