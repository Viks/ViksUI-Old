...
frame:SetScript("OnEvent", function(self, event)
	...
	MageNugManaGem_Frame_Text:SetFont(Viks.font.stylization_font, Viks.font.stylization_font_size * 2, Viks.font.stylization_font_style)
	MageNugManaGem_Frame_Text:SetShadowOffset(Viks.font.stylization_font_shadow and 1 or 0, Viks.font.stylization_font_shadow and -1 or 0)
