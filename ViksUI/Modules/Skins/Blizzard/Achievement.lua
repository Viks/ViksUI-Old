...
local function LoadSkin()
	...
	hooksecurefunc("AchievementButton_DisplayAchievement", function(frame, category, achievement)
		...
		if completed then
			...
			elseif frame.bg3 then
				frame.bg3:SetTexture(unpack(Viks.media.bordercolor))
	...
	for i = 1, 7 do
		...
		frame.bg1:SetTexture(Viks.media.blank_border)
	...
	for _, compare in pairs(compares) do
		for i = 1, 9 do
			...
			_G[frame].bg1:SetTexture(Viks.media.blank_border)
			...
			_G[frame].bg3:SetTexture(unpack(Viks.media.bordercolor))
	...
	hooksecurefunc("AchievementFrameComparison_DisplayAchievement", function(button)
		...
		if player.accountWide then
			...
			player.bg3:SetTexture(unpack(Viks.media.bordercolor))
		end
		...
		if friend.accountWide then
			...
			friend.bg3:SetTexture(unpack(Viks.media.bordercolor))
		end
	end)
	...
	hooksecurefunc("AchievementButton_GetProgressBar", function(index)
		...
		if frame then
			if not frame.skinned then
				...
				frame.bg1:SetTexture(unpack(Viks.media.backdropcolor))
				...
				frame.bg2:SetTexture(unpack(Viks.media.bordercolor))
				...
				frame.bg3:SetTexture(unpack(Viks.media.backdropcolor))
