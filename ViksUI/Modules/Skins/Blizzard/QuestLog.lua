...
local function LoadSkin()
	...
	for i = 1, MAX_NUM_ITEMS do
		...
		_G["QuestInfoItem"..i.."Name"]:SetFont(Viks.media.font, 12)
	...
	QuestInfoSkillPointFramePoints:SetFont(Viks.media.font, 15, "OUTLINE")
	...
	QuestInfoRewardSpellName:SetFont(Viks.media.font, 12)
	...
	QuestInfoSpellObjectiveFrame.Name:SetFont(Viks.media.font, 12)
