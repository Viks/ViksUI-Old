...
local function LoadSkin()
	if Viks.map.enable == true or IsAddOnLoaded("Mapster") then return end


	WorldMapPlayerUpper:EnableMouse(true)
	WorldMapPlayerLower:EnableMouse(true)
	...
	local function FixSkin()
		...
		WorldMapFrameAreaLabel:SetFont(Viks.media.font, 50)
		WorldMapFrameAreaLabel:SetShadowOffset(2, -2)
		WorldMapFrameAreaLabel:SetTextColor(0.9, 0.82, 0.64)

		WorldMapFrameAreaDescription:SetFont(Viks.media.font, 40)
		WorldMapFrameAreaDescription:SetShadowOffset(1, -1)

		WorldMapFrameAreaPetLevels:SetFont(Viks.media.font, 32)
		WorldMapFrameAreaPetLevels:SetShadowOffset(2, -2)

		WorldMapZoneInfo:SetFont(Viks.media.font, 27)
	...
	coords:FontString("PlayerText", Viks.media.font, fontheight)
	coords:FontString("MouseText", Viks.media.font, fontheight)
	...
	WorldMapContinentDropDownButton:HookScript("OnClick", function() DropDownList1:SetScale(Viks.general.uiscale) end)
	WorldMapZoneDropDownButton:HookScript("OnClick", function(self)
		DropDownList1:SetScale(Viks.general.uiscale)
