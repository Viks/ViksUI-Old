...
if Viks.minimapp.enable ~= true or Viks.skins.minimap_buttons ~= true then return end
...
local line = math.ceil(Viks.minimapp.size / 20)

local function PositionAndStyle()
	button:SetSize(20, 20)
	button:SetPoint(unpack(Viks.position.minimap_buttons))
	for i = 1, #buttons do
