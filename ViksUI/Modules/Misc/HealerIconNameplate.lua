...
if Viks.nameplate.enable ~= true or Viks.nameplate.healer_icon ~= true then return end
...
local function CreatePlate(frame, nameFrame)
	...
	if texture then
		...
		frame.HPHeal:SetFont(Viks.font.nameplates_font, 32, Viks.font.nameplates_font_style)
