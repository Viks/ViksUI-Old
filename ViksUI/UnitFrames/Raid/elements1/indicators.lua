...
local Enable = function(self)
    if(self.freebIndicators) then
        ...
        self.AuraStatusTL:SetFont(indicator, Viks.raidframes.indicatorsize, "THINOUTLINE")
        ...
        self.AuraStatusTR:SetFont(indicator, Viks.raidframes.indicatorsize, "THINOUTLINE")
        ...
        self.AuraStatusBL:SetFont(indicator, Viks.raidframes.indicatorsize, "THINOUTLINE")
        ...
        self.AuraStatusBR:SetFont(symbols, Viks.raidframes.symbolsize, "THINOUTLINE")
        ...
        self.AuraStatusCen:SetFont(Viks.media.font, Viks.raidframes.fontsizeEdge, Viks.raidframes.outline)
        self.AuraStatusCen:SetShadowOffset(1.25, -1.25)
        self.AuraStatusCen:SetWidth(Viks.raidframes.width)
