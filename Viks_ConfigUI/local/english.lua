...
L_GUI_AUTOMATION_ACCEPT_QUEST = "Auto accept quest (disabled if hold Shift or Alt)"
...
L_GUI_TOOLTIP_TITLE = "Player title and realm name in tooltip"
...
L_GUI_UF_PLUGINS_VENGEANCE_BAR = "Enable Vengeance bar (for Tanks)"
