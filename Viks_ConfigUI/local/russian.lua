...
L_GUI_ANNOUNCEMENTS_TOY_TRAIN = "Сообщать в чат о применении игрушек"
L_GUI_ANNOUNCEMENTS_SAYS_THANKS = "Благодарить за полезные заклинания"
L_GUI_ANNOUNCEMENTS_PULL_COUNTDOWN = "Отсчитывать время до атаки '/pc #"
...
L_GUI_TOOLTIP_TITLE = "Звание, имя сервера в подсказке"
...
L_GUI_NAMEPLATE_NAME_ABBREV = "Сокращение имен (не работает вместе с отриц. эффектами)"
