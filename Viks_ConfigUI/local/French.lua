...
L_GUI_UF_PLUGINS_COMBO_BAR = "Affichage des points de combo pour les Voleurs/Druides"
...
L_GUI_UF_RAID_VERTICAL_GROUP = "Groupe de raid verticaux(only for heal layout)" -- Needs review
